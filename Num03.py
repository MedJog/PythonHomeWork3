...
summa = 0
for letter in word:
    summa += alphabet.get(letter.upper(),0)
    if alphabet.get(letter.upper(),0) == 0:
        output = 'Элемента "' + letter + '" в словаре нет.'
        print(output)
print(f'Стоимость слова {word} равна {summa} игровых денег')
